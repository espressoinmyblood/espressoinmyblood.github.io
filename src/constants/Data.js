...
export const projectsObject = {
    ...
    description: "Here are <a href='https://espressoinmyblood.github.io/timer/'>the Timer</a> with React Hooks, <a href='https://espressoinmyblood.github.io/todo-list/'>the ToDo List</a>, and <a href='https://espressoinmyblood.github.io/weather/'>the Weather App</a> with APIs - all the desktop versions on pure CSS and modern React.<br/>The app with responsive design and styled-components is the one you are looking at right now. \<br/>Also, here is the beautiful one - <a href='https://espressoinmyblood.github.io/oxford/' >the website</a> for one of the projects of Oxford College with PayPal APIs, responsive design and Hooks, and <a href='https://espressoinmyblood.github.io/pokedex/'> the Pokedex</a> on TypeScript.",
};